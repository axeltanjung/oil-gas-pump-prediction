...
def test_feature_columns_excludes_targets():
    ...
    for t in ["failure_within_7_days", "rul_days", "anomaly_score", "pump_id", "timestamp"]:
...
def test_alert_levels():
    ...
    assert alerts.combine(alerts.NORMAL, alerts.WARNING, alerts.CRITICAL) == alerts.CRITICAL
